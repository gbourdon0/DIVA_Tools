...
import numpy as np
"""
File from https://github.com/F2011B/pythonPltReader/blob/master/tecplotPltReader.py
Read the binary value of the .plt file
"""
...
if __name__ == "__main__":
    f = open("/home/gbourdon/02_DIVA_benchmark_drag/11_5d-1/animation_files/anim000.plt", "rb")
    bytes_list = f.read()

    infos,data = read_data(bytes_list, f)
    #["Zones"][0]["ZoneName"].split(",")[0].split("=")[1])
    print(infos["Zones"][0]["ZoneName"])
    print(infos["Zones"])
